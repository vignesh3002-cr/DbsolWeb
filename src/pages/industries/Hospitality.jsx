...
<p className="text-gray-600 dark:text-gray-300 text-center mb-20 max-w-2xl mx-auto">Lack of real-time data on occupancy, revenue, and operations affects decision-making. Dynamics 365 provides live dashboards and analytics to improve operational visibility.</p>
...
<p className="text-gray-600 dark:text-gray-300 text-center mb-20 max-w-2xl mx-auto">Our Hospitality Technology Solutions, powered by Microsoft Dynamics 365, streamline operations and enhance guest experiences through integrated systems.</p>
...
whileInView={{opacity:1,y:0}}
transition={{delay:index*0.2}}
className={`p-6 shadow-lg ${index%2==0?"bg-gradient-to-r from-yellow-500 to-gray-800 dark:from-gray-800 dark:to-gray-800":"bg-gradient-to-r from-green-400 to-pink-600 dark:from-gray-800 dark:to-gray-800"} dark:bg-gray-800 rounded-xl`}
>
