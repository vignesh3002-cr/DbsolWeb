...
Financial Industry Challenges
    ...
    <p className="text-gray-600 dark:text-gray-300 text-center mb-20 max-w-2xl mx-auto">Financial institutions use Dynamics 365 to manage evolving regulations, ensure compliance, and reduce operational risk.</p>
...
<p className="text-gray-600 dark:text-gray-300 text-center mb-20 max-w-2xl mx-auto">Unified Financial Operations with Dynamics 365, Real-Time Financial Visibility & Reporting, Multi-Entity & Global Financial Consolidation</p>
...
<p className="dark:text-gray-200 text-white text-lg font-serif">{item}</p>
