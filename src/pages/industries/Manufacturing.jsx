...
<p className="text-gray-600 dark:text-gray-300 text-center mb-20 max-w-2xl mx-auto">Inefficient Production Scheduling, Lack of Real-Time Shop Floor Visibility, Difficulty Managing Demand Fluctuations.</p>
...
<p className="text-gray-600 dark:text-gray-300 text-center mb-20 max-w-2xl mx-auto">Advanced Production Scheduling with Dynamics 365, Real-Time Shop Floor Monitoring, Demand-Driven Production Planning.</p>
