...
<p className="text-center mb-20 max-w-2xl mx-auto">Inconsistent Customer Experience Across Channels, Lack of Unified Commerce Platforms, Difficulty Managing Online & Offline Integration.</p>
...
<p className="text-center mb-20 max-w-2xl mx-auto">Omnichannel Retail with Dynamics 365, Seamless Online & In-Store Integration, Consistent Customer Experience Across Channels.</p>
