...
<p className="text-gray-800 dark:text-gray-300 text-center mb-20 max-w-2xl mx-auto">Institutions struggle to provide personalized communication and engagement due to lack of centralized platforms, resulting in lower student satisfaction and retention rates.</p>
...
<p className="text-gray-600 dark:text-gray-300 text-center mb-20 max-w-2xl mx-auto">Leverage Dynamics 365 to centralize student data, streamline admissions, and manage academic records efficiently, ensuring a seamless student lifecycle experience.</p>
...
whileInView={{opacity:1,y:0}}
transition={{delay:index*0.2}}
className={`p-6 shadow-lg ${index%2==0?"bg-gradient-to-r from-yellow-500 to-gray-800 dark:from-gray-800 dark:to-gray-800":"bg-gradient-to-r from-green-400 to-green-700 dark:from-gray-800 dark:to-gray-800"} dark:bg-gray-800 rounded-xl`}
>

<p className=" text-lg font-serif text-white">{item}</p>
