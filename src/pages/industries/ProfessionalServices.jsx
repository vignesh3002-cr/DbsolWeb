...
<p className="text-gray-600 dark:text-gray-300 text-center mb-20 max-w-2xl mx-auto">Professional services firms often use multiple disconnected systems for finance, HR, and project management, leading to data silos and poor collaboration across teams.</p>
...
<p className="text-gray-600 dark:text-gray-300 text-center mb-20 max-w-2xl mx-auto">Manage projects efficiently from initiation to completion using structured planning tools, timelines, and resource allocation features in Dynamics 365.</p>
