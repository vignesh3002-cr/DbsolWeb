...
export default {
  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        "grid-subtle": "linear-gradient(rgba(255,255,255,0.9) 1px,transparent 1px),linear-gradient(90deg,rgba(255,255,255,0.9) 1px,transparent 1px)",
        "gold-gradient": "linear-gradient(90deg,#C8962A,#F5D07A,#C8962A)",
        scanlines: "repeating-linear-gradient(0deg,transparent,transparent 2px,rgba(255,255,255,0.6) 2px,rgba(255,255,255,0.6) 3px)",
        "mask-marquee": "linear-gradient(90deg,transparent 0%,black 12%,black 88%,transparent 100%)",
      },
      backgroundSize: {
        "grid-64": "64px 64px",
        "200pct": "200% auto",
